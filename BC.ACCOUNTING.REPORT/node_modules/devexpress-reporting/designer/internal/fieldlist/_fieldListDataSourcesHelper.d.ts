...
*/
import { DxPromise, IDataSourceInfo } from '@devexpress/analytics-core/analytics-internal';
...
export declare class FieldListDataSourcesHelper implements IDisposable {
    ...
    wrapFieldsCallback(fieldsCallback: (request: IPathRequest) => DxPromise<IDataMemberInfo[]>, state: () => {}, dataSources?: ko.ObservableArray<IDataSourceInfo>, useCache?: boolean): (request: IPathRequest) => DxPromise<IDataMemberInfo[]>;
