...
export class CharacterCombEditingFieldViewModel extends TextEditingFieldViewModelBase {
    constructor(field, pageWidth, pageHeight, page, bounds) {
        ...
        CharacterCombEditingFieldViewModel.setText(this.cells, currentMultiPlatformEngine.unwrap(style['textAlignment']), style.rtl(), field.getEditValue(), rowsCount, colsCount);
        this.addDisposable(this.field.events.on('editValueChanged', (args) => {
            CharacterCombEditingFieldViewModel.setText(this.cells, currentMultiPlatformEngine.unwrap(style['textAlignment']), style.rtl(), args.newValue, rowsCount, colsCount);
        }));
    }
