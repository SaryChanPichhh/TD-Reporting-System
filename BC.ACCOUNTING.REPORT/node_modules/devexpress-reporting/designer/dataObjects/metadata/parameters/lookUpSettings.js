...
export const editedStaticListLookUpSettingsInfo = { ...staticListLookUpSettingsInfo, editor: { custom: 'dxrd-lookUpValues-editing' } };
export const readonlyStaticListLookUpSettingsInfo = { ...staticListLookUpSettingsInfo, editor: designerEditorTemplates.getEditor('lookUpValues') };
