...
import { DxDeferred, DxPromise } from './_jqueryUtils';
...
export declare class FieldListProvider implements IItemsProvider {
    ...
    constructor(fieldListCallback: (pathRequest: IPathRequest) => DxPromise<IDataMemberInfo[]>, rootItems: ko.ObservableArray<IDataSourceInfo>, extenders?: IItemsExtender[], rootItemsNoDragable?: boolean);
    deferreds: DxDeferred<IDataMemberInfo[]>[];
    dispose: () => void;
