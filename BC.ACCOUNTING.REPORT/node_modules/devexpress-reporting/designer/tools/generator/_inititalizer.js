...
export class ReportDesignerInitializer extends CommonDesignerGenerator {
    ...
    _createNewViaWizardAction(reportWizard, designerModel, state) {
        const menuAction = {
            ...
            visible: true,
            hotKey: { altKey: true, keyCode: 'W'.charCodeAt(0) },
            clickAction: () => {
                designerModel._wizardRunner.run('NewViaReportWizard');
            }
        };
        ...
        return ((actions) => {
            ...
            if (reportStorageWebIsRegister()) {
                actions.push({
                    ...
                    disabled: ko.observable(false),
                    visible: true,
                    hotKey: { altKey: true, ctrlKey: undefined, keyCode: 'N'.charCodeAt(0) },
                    clickAction: () => {
                        designerModel.isLoading(true);
            ...
            if (scriptsEditor) {
                actions.push({
                    ...
                    hotKey: { altKey: true, ctrlKey: undefined, keyCode: 'R'.charCodeAt(0) },
                    clickAction: () => {
