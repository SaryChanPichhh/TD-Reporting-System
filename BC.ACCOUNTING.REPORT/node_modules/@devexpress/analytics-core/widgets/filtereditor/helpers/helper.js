...
export class FilterEditorHelper {
    ...
    constructor(serializer) {
        ...
        this.filterEditorOperators.time = [].concat(this.filterEditorOperators._common, [
            { name: 'Is null', _type: 'unary', insertVal: 'Is Null', value: UnaryOperatorType.IsNull, type: UnaryOperatorType, localizationId: 'StringId.FilterClauseIsNull' },
            { name: 'Is not null', _type: 'unary', insertVal: 'Is Not Null', value: UnaryOperatorType.IsNull, type: UnaryOperatorType, reverse: true, localizationId: 'StringId.FilterClauseIsNotNull' },
            { name: 'Is any of', _type: 'in', value: 'In', insertVal: 'In()', type: InOperator, localizationId: 'StringId.FilterClauseAnyOf' },
            { name: 'Is none of', _type: 'in', value: 'In', type: InOperator, reverse: true, localizationId: 'StringId.FilterClauseNoneOf' },
            { name: 'Is same time', _type: 'function', insertVal: 'IsSameTime(, )', value: FunctionOperatorType.IsSameTime, type: FunctionOperatorType, localizationId: 'StringId.FilterCriteriaToStringFunctionIsSameTime' },
            { name: 'Is same hour', _type: 'function', insertVal: 'IsSameHour(, )', value: FunctionOperatorType.IsSameHour, type: FunctionOperatorType, localizationId: 'StringId.FilterCriteriaToStringFunctionIsSameHour' },
            { name: 'Before Midday', _type: 'function', insertVal: 'BeforeMidday()', emptyRightPart: true, value: FunctionOperatorType.BeforeMidday, type: FunctionOperatorType, localizationId: 'StringId.FilterCriteriaToStringFunctionBeforeMidday' },
            { name: 'After Midday', _type: 'function', insertVal: 'AfterMidday()', emptyRightPart: true, value: FunctionOperatorType.AfterMidday, type: FunctionOperatorType, localizationId: 'StringId.FilterCriteriaToStringFunctionAfterMidday' },
            { name: 'Is Night', _type: 'function', insertVal: 'IsNight()', emptyRightPart: true, value: FunctionOperatorType.IsNight, type: FunctionOperatorType, localizationId: 'StringId.FilterCriteriaToStringFunctionIsNight' },
            { name: 'Is Morning', _type: 'function', insertVal: 'IsMorning()', emptyRightPart: true, value: FunctionOperatorType.IsMorning, type: FunctionOperatorType, localizationId: 'StringId.FilterCriteriaToStringFunctionIsMorning' },
            { name: 'Is Afternoon', _type: 'function', insertVal: 'IsAfternoon()', emptyRightPart: true, value: FunctionOperatorType.IsAfternoon, type: FunctionOperatorType, localizationId: 'StringId.FilterCriteriaToStringFunctionIsAfternoon' },
            { name: 'Is Evening', _type: 'function', insertVal: 'IsEvening()', emptyRightPart: true, value: FunctionOperatorType.IsEvening, type: FunctionOperatorType, localizationId: 'StringId.FilterCriteriaToStringFunctionIsEvening' },
            { name: 'Is Work Time', _type: 'function', insertVal: 'IsWorkTime()', emptyRightPart: true, value: FunctionOperatorType.IsWorkTime, type: FunctionOperatorType, localizationId: 'StringId.FilterCriteriaToStringFunctionIsWorkTime' },
            { name: 'Is Free Time', _type: 'function', insertVal: 'IsFreeTime()', emptyRightPart: true, value: FunctionOperatorType.IsFreeTime, type: FunctionOperatorType, localizationId: 'StringId.FilterCriteriaToStringFunctionIsFreeTime' },
            { name: 'Is Lunch Time', _type: 'function', insertVal: 'IsLunchTime', emptyRightPart: true, value: FunctionOperatorType.IsLunchTime, type: FunctionOperatorType, localizationId: 'StringId.FilterCriteriaToStringFunctionIsLunchTime' },
            { name: 'Is Last Hour', _type: 'function', insertVal: 'IsLastHour()', emptyRightPart: true, value: FunctionOperatorType.IsLastHour, type: FunctionOperatorType, localizationId: 'StringId.FilterCriteriaToStringFunctionIsLastHour' },
            { name: 'Is This Hour', _type: 'function', insertVal: 'IsThisHour()', emptyRightPart: true, value: FunctionOperatorType.IsThisHour, type: FunctionOperatorType, localizationId: 'StringId.FilterCriteriaToStringFunctionIsThisHour' },
            { name: 'Is Next Hour', _type: 'function', insertVal: 'IsNextHour()', emptyRightPart: true, value: FunctionOperatorType.IsNextHour, type: FunctionOperatorType, localizationId: 'StringId.FilterCriteriaToStringFunctionIsNextHour' }
        ]);
        this.filterEditorOperators.datetime = [].concat(this.filterEditorOperators.date);
