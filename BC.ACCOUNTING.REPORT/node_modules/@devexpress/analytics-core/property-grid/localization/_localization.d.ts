...
*/
import { DxDeferred, DxPromise } from '../../core/utils/_jqueryUtils';
...
export declare function resolveFromPromises<T>(promises: DxPromise<any>[], createModel: () => T): DxDeferred<T>;
...
export declare function formatTime(val: any): string;
