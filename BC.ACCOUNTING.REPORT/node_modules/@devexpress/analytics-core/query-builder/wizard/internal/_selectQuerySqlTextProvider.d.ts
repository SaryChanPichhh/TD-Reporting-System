...
export declare class SelectQuerySqlTextProvider {
    ...
    private _connection;
    constructor(_selectStatementCallback: (connection: SqlDataConnection, queryJSON: string) => DxPromise<ISelectStatementResponse>, _connection: () => SqlDataConnection);
    getQuerySqlText(newQuery: TableQuery): DxPromise<ISelectStatementResponse>;
}
