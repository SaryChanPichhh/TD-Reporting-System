...
export declare function validateExpression(options: IValidateExpressionOptions): import("../core/utils/_jqueryUtils").DxPromise<any>;
...
export declare function getParentContainer(el: HTMLElement, container?: string): HTMLElement;
