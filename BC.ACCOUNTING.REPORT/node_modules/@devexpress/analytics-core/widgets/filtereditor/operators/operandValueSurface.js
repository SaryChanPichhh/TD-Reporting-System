...
import { formatDate, formatTime } from '../../../property-grid/localization/_localization';
...
export class OperandValueSurface extends OperandSurfaceBase {
    ...
    constructor(operator, parent, fieldListProvider, path) {
        ...
        this._updateDate = function (specifics) {
            if (specifics === 'date' || specifics === 'time' || specifics === 'datetime') {
        ...
        this.getDateEditorOptions = (element, $root, specifics) => {
            return {
