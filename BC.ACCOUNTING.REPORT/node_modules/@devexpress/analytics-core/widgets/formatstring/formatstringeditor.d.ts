...
export interface IFormatStringEditorActions {
    updatePreview?: (value: string, category: string, pattern: string) => DxPromise<_IFormatStringEditorPreviewResponse>;
    saveCustomPattern?: (category: string, pattern: string) => DxPromise<boolean>;
    removeCustomPattern?: (category: string, pattern: string) => DxPromise<boolean>;
}
