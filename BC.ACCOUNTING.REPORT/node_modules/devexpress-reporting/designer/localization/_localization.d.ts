...
*/
import { ISerializableModel, ISerializationInfo } from '@devexpress/analytics-core/analytics-utils';
import * as ko from 'knockout';
import { ILocalizedControl } from '../controls/utils/_localizationUtils';
import { SerializableModel } from '@devexpress/analytics-core/core/elements/serializableModel';
...
export declare class LocalizationInfo {
    ...
    setValue: (component: ILocalizedControl, propertyName: string, value: any, target: SerializableModel) => void;
    private _createLocalizationItem;
    serialize(canSerialize: (contol: any) => boolean, existingTargets: ILocalizationItemInfo[]): LocalizationItem[];
