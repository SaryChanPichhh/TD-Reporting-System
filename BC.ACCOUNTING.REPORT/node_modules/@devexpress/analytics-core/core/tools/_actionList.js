...
export class ActionLists extends ActionListsBase {
    ...
    constructor(surfaceContext, selection, undoEngine, customizeActions, enabled, copyPasteStrategy, zoomStep = ko.observable(0.01), isLocked = (item) => false) {
        ...
        if (selection) {
            ...
            this._disposables.push(this._keyboardHelper);
            actions.push({
                id: ActionId.Cut,
                text: 'Cut',
        ...
        actions.push({
            ...
            visible: true,
            hotKey: [{ ctrlKey: false, keyCode: 109 }, { ctrlKey: true, keyCode: 189 }],
            zoomStep: zoomStep,
        ...
        actions.push({
            ...
            visible: true,
            hotKey: { ctrlKey: true, keyCode: 48 },
            clickAction: () => {
        ...
        actions.push({
            ...
            visible: true,
            hotKey: [{ ctrlKey: false, keyCode: 107 }, { ctrlKey: true, keyCode: 187 }],
            zoomStep: zoomStep,
            isContextMenuAction: false,
            clickAction: () => {
