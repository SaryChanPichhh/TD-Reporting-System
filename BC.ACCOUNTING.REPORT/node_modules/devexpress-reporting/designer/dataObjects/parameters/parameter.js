...
*/
import { DotnetTypes, extend, formatUnicorn, getLocalization } from '@devexpress/analytics-core/analytics-internal';
...
export class Parameter extends Disposable {
    ...
    constructor(model, _report, serializer) {
            ...
            write: (val) => {
                ...
                if (val !== oldVal) {
                    ...
                    setTimeout(() => {
                        ...
                        if (this.isMultiValue())
                            return;
                        if (val === DotnetTypes.SystemDateTime) {
        ...
        this.valueInfo = ko.pureComputed(() => {
            ...
            if (this.type() === DotnetTypes.SystemString || this.isMultiValue()) {
                result.defaultVal = '';
            }
            return result;
        });
