...
{
    public partial class APSupplierInvoiceDetailReport : DevExpress.XtraReports.UI.XtraReport
    {
        public APSupplierInvoiceDetailReport()
        {
            InitializeComponent();
        }
        public APSupplierInvoiceDetailReport(APSupplierInvoiceDetailDto dto , string reportPath)
        {
