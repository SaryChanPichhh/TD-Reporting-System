...
export class NativeModelSerializer {
    ...
    constructor(options) {
        ...
        this._options = {
            useRefs: true,
            serializeDate: (value, type) => serializeDate(value, undefined, type)
        };
        this._refTable = {};
        this._linkTable = {};
        ...
        if (modelPropertyInfo.alwaysSerialize || ((value !== undefined && value !== null) && ((isPlainObject(value) || !isEmptyObject(value)) || (Array.isArray(value) && value.length > 0) || (!Array.isArray(value) && !isPlainObject(value))) && (value !== defaultVal))) {
            if (modelPropertyInfo.link) {
                ...
                if (value['isEmpty'] && value['isEmpty']()) {
                    ...
                    resultValue = modelPropertyInfo.toJsonObject ? modelPropertyInfo.toJsonObject(value, this, refs, viewModel) : value.toString();
                }
            }
                ...
                if (value instanceof Date) {
                    resultValue = this._options && this._options.serializeDate(value, this.unwrapPropertyValue(viewModel['type']));
                }
                else {
                    resultValue = value;
                }
