...
export class AIPanelViewModel extends BaseRenderingModel {
    ...
    updateViewModel(args) {
        ...
        if (args.propertyName === 'aiProcessingResultText') {
        ...
        else if (args.propertyName === 'pageSelecBoxVisible' || args.propertyName === 'pagesListDataSource') {
            viewModel.pageSelecBoxOptions.dataSource = this.pagesListDataSource;
            viewModel.pageSelecBoxOptions.visible = this.pageSelecBoxVisible;
            viewModel.pageSelecBoxVisible = this.pageSelecBoxVisible;
        }
        else if (args.propertyName === 'proceedForAllChunks') {
            viewModel.proceedForAllChunks = this.proceedForAllChunks;
            ...
            viewModel.selectedPage = this.selectedPage;
        }
        else if (args.propertyName === 'selectedTarget') {
            viewModel.targetSelecBoxOptions.value = this.selectedTarget;
        }
        else if (args.propertyName === 'selectedLanguage') {
            viewModel.languageSelecBoxOptions.value = this.selectedLanguage;
        }
...
__decorate([
    mutable(false)
], AIPanelViewModel.prototype, "pageSelecBoxVisible", void 0);
__decorate([
    mutable()
