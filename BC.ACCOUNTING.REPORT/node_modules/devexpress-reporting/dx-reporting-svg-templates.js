...
SvgTemplatesEngine.addTemplates({
    ...
    'dxrd-svg-menu-aimenu': '<svg data-bind="svgAttrs" xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="none"><path class="dxd-icon-fill" d="M13.319 11.156c-.689 3.825-3.339 6.475-7.169 7.169a.18.18 0 000 .356c3.825.688 6.475 3.338 7.169 7.169a.18.18 0 00.356 0c.688-3.825 3.337-6.475 7.169-7.169a.18.18 0 000-.356c-3.825-.688-6.475-3.337-7.169-7.169a.18.18 0 00-.356 0zm7.561-5.05c-.462 2.55-2.225 4.319-4.775 4.775a.12.12 0 00-.075.198.12.12 0 00.075.04c2.55.462 4.319 2.225 4.775 4.775a.12.12 0 00.238 0c.462-2.55 2.225-4.319 4.775-4.775a.12.12 0 00.075-.198.12.12 0 00-.075-.04c-2.55-.462-4.319-2.225-4.775-4.775a.12.12 0 00-.238 0z"/></svg>',
    ...
    'dxrd-svg-tabs-aitab': '<svg data-bind="svgAttrs" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg"><defs></defs><path class="dxd-icon-fill" d="M11.71 8.25C10.61 14.37 6.37 18.61.24 19.72c-.33.06-.33.51 0 .57 6.12 1.1 10.36 5.34 11.47 11.47.06.33.51.33.57 0 1.1-6.12 5.34-10.36 11.47-11.47.33-.06.33-.51 0-.57-6.12-1.1-10.36-5.34-11.47-11.47a.288.288 0 00-.57 0zM23.81.17c-.74 4.08-3.56 6.91-7.64 7.64-.22.04-.22.34 0 .38 4.08.74 6.91 3.56 7.64 7.64.04.22.34.22.38 0 .74-4.08 3.56-6.91 7.64-7.64.22-.04.22-.34 0-.38-4.08-.74-6.91-3.56-7.64-7.64a.192.192 0 00-.38 0z" fill="#fff"/></svg>',
