...
*/
import { serializeParameterDate } from '@devexpress/analytics-core/analytics-utils';
...
export function parameterValueToJsonObject(value, serializer, refs, parameter) {
    const result = ReportParameterHelper.getSerializationValue(value, (date) => serializeParameterDate(date, parameter.type()));
