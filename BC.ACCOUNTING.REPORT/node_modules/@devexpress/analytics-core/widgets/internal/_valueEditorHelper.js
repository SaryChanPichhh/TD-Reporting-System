...
import { extend, isFunction } from '../../serializer/_utils';
    ...
    static getValueEditorOptions(regExpEditing, validate, defaultVal, extendOptions = {}) {
        const options = {
            ...
            onKeyDown: e => {
                ...
                if (!char)
                    return;
                const input = $dx(e.element).find('input')[0];
                let $input = $dx(input);
...
ValueEditorHelper.editors = {
    ...
    [DotnetTypes.SystemDateTime]: {
        type: 'datetime'
    },
    [DotnetTypes.SystemDateOnly]: {
        type: 'date'
    },
    [DotnetTypes.SystemTimeOnly]: {
        type: 'time'
    }
};
