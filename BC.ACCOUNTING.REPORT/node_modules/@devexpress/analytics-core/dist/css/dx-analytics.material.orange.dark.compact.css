/**
* DevExpress Analytics (dist\css\dx-analytics.material.orange.dark.compact.css)
* Version:  24.2.3
...
.dx-designer-viewport .dxd-scrollbar-color {
  scrollbar-face-color: #3e3e48;
  scrollbar-track-color: #757585;
  scrollbar-arrow-color: #525260;
  -ms-scrollbar-face-color: #3e3e48;
  -ms-scrollbar-track-color: #757585;
  -ms-scrollbar-arrow-color: #525260;
}
...
.dx-designer .dx-designer-viewport .dxrd-fieldslist-wrapper .dxrd-right-panel-header #btn-add-dataSource .dx-button-content {
  padding: 4px;
}
.dx-designer .dx-designer-viewport .dxrd-fieldslist-wrapper .dxrd-right-panel-header #btn-add-dataSource .dx-button-content .dx-icon-dxrd {
  width: auto;
  height: auto;
  display: inline-flex;
...
.dx-designer .dx-designer-viewport .dxrd-fieldslist-wrapper .dxrd-right-panel-header #btn-add-dataSource .dx-button-content .dx-button-text {
  font-size: 11px;
}
...
.dx-overlay-wrapper .dx-popup-content .dxa-tasks-smart-tag-content .dx-editors .dx-fieldset .dx-editor .dx-checkbox.propertygrid-editor-checkbox {
  margin-top: 0;
}
.dx-designer-viewport .dxd-description_info-icon-fill {
  fill: #757585;
...
.dx-designer-viewport .dx-editors .dx-fieldset .dx-field .dx-field-label:not(.dxrd-textalignment-editor-label) {
  padding-top: 8px;
}
...
.dx-designer-viewport .dx-checkbox.dx-add-queries-page-checkbox {
  top: 3px;
}
...
.dx-designer-viewport .dxrd-error-panel .dxrd-error-panel-content .dx-buttongroup-first-item .dx-buttongroup-item-content {
  padding-left: 4px;
}
