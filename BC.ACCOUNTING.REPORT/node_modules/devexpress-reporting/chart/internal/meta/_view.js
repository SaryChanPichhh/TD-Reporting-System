...
const boxWidth = { propertyName: 'boxWidth', modelName: '@BoxWidth', displayName: 'Box Width', localizationId: 'DevExpress.XtraCharts.BoxPlotSeriesView.BoxWidth', editor: editorTemplates.getEditor('numeric'), defaultVal: 0.6, editorOptions: { min: 0, step: 0.1 } };
const boxDistance = { propertyName: 'boxDistance', modelName: '@BoxDistance', displayName: 'Box Distance', localizationId: 'DevExpress.XtraCharts.BoxPlotSeriesView.BoxDistance', editor: editorTemplates.getEditor('numeric'), defaultVal: 0 };
const boxDistanceFixed = { propertyName: 'boxDistanceFixed', modelName: '@BoxDistanceFixed', displayName: 'Box Distance Fixed', localizationId: 'DevExpress.XtraCharts.BoxPlotSeriesView.BoxDistanceFixed', editor: editorTemplates.getEditor('numeric'), defaultVal: 1 };
const capWidthPercentage = { propertyName: 'capWidthPercentage', modelName: '@CapWidthPercentage', displayName: 'Cap Width Percentage', localizationId: 'DevExpress.XtraCharts.BoxPlotSeriesView.CapWidthPercentage', editor: editorTemplates.getEditor('numeric'), defaultVal: 50 };
const processPoints = {
    propertyName: 'processPoints', modelName: '@ProcessPoints', displayName: 'Process Points', localizationId: 'DevExpress.XtraCharts.EmptyPointOptions.ProcessPoints', editor: editorTemplates.getEditor('combobox'), valuesArray: [{ value: 'Interpolate', displayValue: 'Interpolate', localizationId: 'DevExpress.XtraCharts.ProcessEmptyPointsMode.Interpolate' }, { value: 'InsertZero', displayValue: 'Insert Zero', localizationId: 'DevExpress.XtraCharts.ProcessEmptyPointsMode.InsertZero' }, { value: 'Ignore', displayValue: 'Ignore', localizationId: 'DevExpress.XtraCharts.ProcessEmptyPointsMode.Ignore' }], defaultVal: 'InsertZero'
};
const emptyPointInfo = [color1, processPoints, tag];
const emptyPointOptions = { propertyName: 'emptyPointOptions', modelName: 'EmptyPointOptions', displayName: 'Empty Point Options', localizationId: 'DevExpress.XtraCharts.XYDiagramSeriesViewBase.EmptyPointOptions', editor: editorTemplates.getEditor('objecteditor'), info: emptyPointInfo };
const equalBoxWidth = { propertyName: 'equalBoxWidth', modelName: '@EqualBoxWidth', displayName: 'Equal Box Width', localizationId: 'DevExpress.XtraCharts.BoxPlotSeriesView.EqualBoxWidth', editor: editorTemplates.getEditor('bool'), defaultVal: true };
const meanAndMedianColor = { propertyName: 'meanAndMedianColor', modelName: '@MeanAndMedianColor', displayName: 'Mean and Median Color', localizationId: 'DevExpress.XtraCharts.BoxPlotSeriesView.MeanAndMedianColor', from: colorFromString, toJsonObject: colorToString, editor: editorTemplates.getEditor('customColorEditor'), defaultVal: 'transparent' };
const meanLineVisible = { propertyName: 'meanLineVisible', modelName: '@MeanLineVisible', displayName: 'Mean Line Visible', localizationId: 'DevExpress.XtraCharts.BoxPlotSeriesView.MeanLineVisible', editor: editorTemplates.getEditor('bool'), defaultVal: false };
...
const meanMarkerSize = { propertyName: 'meanMarkerSize', modelName: '@MeanMarkerSize', displayName: 'Mean Marker Size', localizationId: 'DevExpress.XtraCharts.BoxPlotSeriesView.MeanMarkerSize', editor: editorTemplates.getEditor('numeric'), defaultVal: 15 };
...
const outlierMarkerSize = { propertyName: 'outlierMarkerSize', modelName: '@OutlierMarkerSize', displayName: 'Outlier Marker Size', localizationId: 'DevExpress.XtraCharts.BoxPlotSeriesView.OutlierMarkerSize', editor: editorTemplates.getEditor('numeric'), defaultVal: 10 };
