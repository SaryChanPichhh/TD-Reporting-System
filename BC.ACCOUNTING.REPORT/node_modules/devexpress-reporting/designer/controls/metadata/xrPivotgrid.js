...
import { appearanceInfo, appearancesInfo, caption, pivotGridFieldsSerializable } from './pivotgrid/pivotgridfield';
import { anchorHorizontal, anchorVertical } from './properties/anchoring';
import { dataMember, dataSource, defaultBooleanValuesArray, keepTogether, rtl } from './properties/metadata';
import { baseControlProperties, bookmarkGroup, sizeLocation } from './properties/metadataGroups';
import { pivotScripts } from './properties/scriptMetadata';
import { pivotGridStyles } from './properties/style';
const linesAppearance = { propertyName: 'linesAppearance', modelName: 'Lines', displayName: 'Lines', localizationId: 'DevExpress.XtraReports.UI.PivotGrid.XRPivotGridAppearances.Lines', info: appearanceInfo, editor: editorTemplates.getEditor('objecteditor') };
export const pivotGridAppearances = { propertyName: 'appearances', modelName: 'Appearance', displayName: 'Appearance', localizationId: 'DevExpress.XtraReports.UI.XRPivotGrid.Appearance', info: appearancesInfo.concat(linesAppearance), editor: editorTemplates.getEditor('objecteditor') };
...
const enabled = { propertyName: 'enabled', modelName: '@Enabled', displayName: 'Enabled', localizationId: 'DevExpress.XtraPivotGrid.PrefilterBase.Enabled', defaultVal: true, editor: editorTemplates.getEditor('bool'), from: parseBool };
const prefilterSerializationsInfo = [criteriaString, criteriaStringEditable, enabled];
export const prefilter = { propertyName: 'prefilter', modelName: 'Prefilter', displayName: 'Prefilter', localizationId: 'DevExpress.XtraReports.UI.XRPivotGrid.Prefilter', info: prefilterSerializationsInfo, editor: editorTemplates.getEditor('objecteditor') };
const autoTransposeChart = { propertyName: 'autoTransposeChart', modelName: '@AutoTransposeChart', displayName: 'Auto Transpose Chart', localizationId: 'DevExpress.XtraPivotGrid.PivotGridOptionsChartDataSource.AutoTransposeChart', defaultVal: false, editor: editorTemplates.getEditor('bool'), from: parseBool }, dataProvideMode = {
    propertyName: 'dataProvideMode', modelName: '@DataProvideMode', displayName: 'Data Provide Mode', localizationId: 'DevExpress.XtraPivotGrid.PivotGridOptionsChartDataSource.DataProvideMode', defaultVal: 'ProvideLastLevelData', editor: editorTemplates.getEditor('combobox'), valuesArray: [
    ...
    propertyName: 'dataProvidePriority', modelName: '@DataProvidePriority', displayName: 'Data Provide Priority', localizationId: 'DevExpress.XtraPivotGrid.PivotGridOptionsChartDataSource.DataProvidePriority', defaultVal: 'Rows', editor: editorTemplates.getEditor('combobox'), valuesArray: [
    ...
    propertyName: 'fieldValuesProvideMode', modelName: '@FieldValuesProvideMode', displayName: 'Field Values Provide Mode', localizationId: 'DevExpress.XtraPivotGrid.PivotGridOptionsChartDataSource.FieldValuesProvideMode', defaultVal: 'Default', editor: editorTemplates.getEditor('combobox'), valuesArray: [
...
const allowCrossGroupVariation = { propertyName: 'allowCrossGroupVariation', modelName: '@AllowCrossGroupVariation', displayName: 'Allow Cross Group Variation', localizationId: 'DevExpress.XtraPivotGrid.PivotGridOptionsData.AllowCrossGroupVariation', defaultVal: true, editor: editorTemplates.getEditor('bool'), from: parseBool }, autoExpandGroups = { propertyName: 'autoExpandGroups', modelName: '@AutoExpandGroups', displayName: 'Aut oExpand Groups', localizationId: 'DevExpress.XtraPivotGrid.PivotGridOptionsData.AutoExpandGroups', defaultVal: 'Default', editor: editorTemplates.getEditor('combobox'), valuesArray: defaultBooleanValuesArray }, caseSensitive = { propertyName: 'caseSensitive', modelName: '@CaseSensitive', displayName: 'Case Sensitive', localizationId: 'DevExpress.XtraPivotGrid.PivotGridOptionsData.CaseSensitive', defaultVal: true, editor: editorTemplates.getEditor('bool'), from: parseBool }, dataFieldUnboundExpressionMode = {
    propertyName: 'dataFieldUnboundExpressionMode', modelName: '@DataFieldUnboundExpressionMode', displayName: 'Data Field Unbound Expression Mode', localizationId: 'DevExpress.XtraPivotGrid.PivotGridOptionsData.DataFieldUnboundExpressionMode', defaultVal: 'Default', editor: editorTemplates.getEditor('combobox'), valuesArray: [
...
const area = {
    ...
    propertyName: 'fieldNaming', modelName: '@FieldNaming', displayName: 'Field Naming', localizationId: 'DevExpress.XtraPivotGrid.PivotGridOptionsDataField.FieldNaming', defaultVal: 'FieldName', editor: editorTemplates.getEditor('combobox'), valuesArray: [
...
const columnTotalsLocation = { propertyName: 'columnTotalsLocation', modelName: '@ColumnTotalsLocation', displayName: 'Column Totals Location', localizationId: 'DevExpress.XtraPivotGrid.Data.PivotGridOptionsViewBase.ColumnTotalsLocation', defaultVal: 'Far', editor: editorTemplates.getEditor('combobox'), valuesArray: [{ value: 'Near', displayValue: 'Near', localizationId: 'DevExpress.XtraPivotGrid.PivotTotalsLocation.Near' }, { value: 'Far', displayValue: 'Far ', localizationId: 'DevExpress.XtraPivotGrid.PivotTotalsLocation.Far' }] }, groupFieldsInCustomizationWindow = { propertyName: 'groupFieldsInCustomizationWindow', modelName: '@GroupFieldsInCustomizationWindow', displayName: 'Group Fields in the Customization Window', localizationId: 'DevExpress.XtraPivotGrid.PivotGridOptionsView.GroupFieldsInCustomizationWindow', defaultVal: true, editor: editorTemplates.getEditor('bool'), from: parseBool }, rowTotalsLocation = {
    ...
    showTotalsForSingleValues, showVertLines], optionsView = { propertyName: 'optionsView', modelName: 'OptionsView', displayName: 'View Options', localizationId: 'DevExpress.XtraReports.UI.XRPivotGrid.OptionsView', info: optionsViewInfo, editor: editorTemplates.getEditor('objecteditor') };
export const pivotGridOptions = [optionsChartDataSource, optionsDataField, optionsData, optionsPrint, optionsView];
export const pivotGridSerializationsInfo = [
    pivotGridAppearances,
    anchorVertical, anchorHorizontal, dataSource, dataMember, prefilter,
    keepTogether,
