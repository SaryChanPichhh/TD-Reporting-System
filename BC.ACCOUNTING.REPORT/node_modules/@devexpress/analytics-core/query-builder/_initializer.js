...
function _createQueryBuilder(element, options, callbacks, applyBindings = true) {
    ...
    designerModel.showPreview = () => {
        ...
        wrapper.getDataPreview(dataConnection, PrepareRequestArgs(query().serialize(true)))
            .done((data) => {
    ...
    designerModel.showStatement = () => {
        ...
        wrapper.getSelectStatement(dataConnection, PrepareRequestArgs(query().serialize(true)))
            .done((data) => {
