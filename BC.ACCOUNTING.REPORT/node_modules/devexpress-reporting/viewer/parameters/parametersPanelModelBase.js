...
import { getLocalization, PrepareRequestArgs, TabInfoWithPropertyGrid } from '@devexpress/analytics-core/analytics-utils-native';
...
export class ParametersPanelModelBase extends ParameterPanelItemBase {
    ...
    constructor(parametersHolder, parameterHelper, enableKeyboardSupport, getRootElement) {
        ...
        this._getParametersStateRequest = (argsObject) => {
            return sendRequest(HandlerUri(), 'getParametersState', PrepareRequestArgs(argsObject), (message, jqXHR, textStatus) => this._parametersHolder._processError(getLocalization('Cannot supply filtered lookup values to a report parameter editor', 'ASPxReportsStringId.WebDocumentViewer_GetLookUpValuesError'), jqXHR));
        };
