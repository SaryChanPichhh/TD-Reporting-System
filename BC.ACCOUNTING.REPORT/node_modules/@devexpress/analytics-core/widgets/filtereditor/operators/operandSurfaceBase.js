...
export class OperandSurfaceBase extends CriteriaOperatorSurface {
    ...
    getConvertableParameters(destinationSpecifics, destinationType) {
        ...
        return this.helper.parameters().filter((item) => {
            ...
            if (sourceSpecifics == null || destinationSpecifics == null)
                return false;
            if (destinationSpecifics === 'date' && isFunction(item.type)) {
                return item.type().indexOf(destinationType) > 0;
            }
    ...
    get changeTypeItems() {
        ...
        if (this.helper.canChoiceParameters && (this.getConvertableParameters(this.parent.specifics(), ko.unwrap(this.parent.dataType)).length > 0 || this.helper.canCreateParameters)) {
