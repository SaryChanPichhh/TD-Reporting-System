...
declare module DevExpress.Analytics.Utils {
    ...
    export function serializeDate(date: Date, delimiter?: string, type?: string): string;
    export function serializeParameterDate(date: Date, type: string): string;
    export function serializeParameterDateUTC(date: Date, type: string): string | Date;
    ...
    export let _requestContentType: string;
    ...
    export const PrepareRequestArgs: (args: any, encode?: boolean, stringify?: boolean) => any;
    export const GetRequestBody: (data: any) => {};
    export const requestManager: {
        ...
        _setRequestHeader: (settings: JQueryAjaxSettings | DevExpress.Analytics.Internal.IRequestManagerSettings) => void;
...
declare module DevExpress.Analytics.Internal {
    ...
    export enum DotnetTypes {
        ...
        SystemDateOnly = "System.DateOnly",
        SystemTimeOnly = "System.TimeOnly",
        SystemTimeSpan = "System.TimeSpan",
        SystemObject = "System.Object",
        SystemBiteArray = "System.Byte[]",
        DevExpressExpression = "DevExpress.DataAccess.Expression"
    }
    ...
    export class BaseAction extends BaseRenderingModel<DevExpress.Analytics.Utils.IActionViewModel> implements IAction {
        ...
        hasSeparator: boolean;
        contentData: any;
        hotKey: DevExpress.Analytics.Utils.IHotKey | DevExpress.Analytics.Utils.IHotKey[];
        clickAction: (model: any) => void;
    ...
    export type IResizableOptions = IResizable & {
        $element?: Element;
        starting?: (event: MouseEvent, container: HTMLElement) => void;
        resizing?: (boundsDiff: DevExpress.Analytics.Elements.IArea) => void;
        stopped?: () => void;
        zoom?: number;
    ...
    export class FetchRequestManager implements IRequestManager {
        ...
        prepareRequestArgs: (args: any, encode: boolean, stringify: boolean) => any;
        constructor(fetchSettingsFn: () => DevExpress.Analytics.Internal.IRequestManagerSettings, getRequestBodyFn: (data: any) => any, prepareRequestArgsFn: (args: any, encode: boolean, stringify: boolean) => any);
    ...
    export type DimensionNotationsModelOptions = {
        enabled: () => boolean;
        surface: ko.Observable<{
            measureUnit: ko.Subscribable<DevExpress.Analytics.Internal.MeasureUnit>;
            zoom: ko.Subscribable<number>;
        }>;
        isVerticalAxisVisible: (controlModel: any) => boolean;
        isHorizontalAxisVisible: (controlModel: any) => boolean;
        isLocatedInsideContainer: (controlModel: any) => boolean;
    };
    export class DimensionNotationsModel {
        ...
        private dHeight;
        private dWidth;
        constructor(_options: DimensionNotationsModelOptions);
        private renderTemplate;
        private getFormattedString;
        start(container: HTMLElement): void;
        stop(): void;
        updateSize(boundsDiff: DevExpress.Analytics.Elements.IArea): void;
    }
    ...
    export function base64DecodeUnicode(base64string: string): string;
...
declare module DevExpress.Analytics.Widgets.Internal {
    ...
    export function createNumericEditor(dotNetTypeFullName: DevExpress.Analytics.Internal.DotnetTypes, specifics: string): {
        header: string;
        editorType: any;
    };
    export function createDateEditor(dotNetTypeFullName: DevExpress.Analytics.Internal.DotnetTypes): {
        header: string;
        editorType: any;
    };
...
declare module DevExpress.Analytics.Serializer.Native {
    ...
    export interface IModelSerializerOptions {
        useRefs: boolean;
        serializeDate?: (date: Date, type: string) => string;
    }
...
declare module DevExpress.Analytics.Widgets {
    ...
    import ILocalizationInfo = DevExpress.Analytics.Internal.ILocalizationInfo;
    export type BaseEditors = "bool" | "boolSelect" | "numeric" | "modificators" | "combobox" | "comboboxEditable" | "text" | "image" | "file" | "commonCollection" | "font" | "stringArray" | "guid" | "date" | "dateOnly" | "timeOnly" | "nullableDate" | "borders" | "textAlignment" | "objecteditorCustom" | "objecteditor" | "inplaceObjectEditor" | "field" | "dataMember" | "filterEditor" | "formatEditor" | "expressionEditor" | "customColorEditor" | "sbyte" | "decimal" | "int64" | "int32" | "int16" | "single" | "double" | "byte" | "uint16" | "uint32" | "uint64";
    ...
    export class FilterEditorHelper {
        ...
        filterEditorOperators: {
            ...
            datetime: DevExpress.Analytics.Criteria.Utils.ICriteriaChangeOperator[];
            date: DevExpress.Analytics.Criteria.Utils.ICriteriaChangeOperator[];
            time: DevExpress.Analytics.Criteria.Utils.ICriteriaChangeOperator[];
...
declare module DevExpress.Analytics.Elements {
    ...
    export class ElementViewModel<T extends string = string> extends Disposable implements IElementViewModel<T>, IControlPropertiesViewModel<T> {
        ...
        getInfo(): DevExpress.Analytics.Utils.ISerializationInfoArray;
        createControl(model: any, serializer?: DevExpress.Analytics.Utils.IModelSerializer): IElementViewModel<string>;
        dispose(): void;
...
declare module DevExpress.Analytics.Criteria {
    ...
    export enum FunctionOperatorType {
        ...
        LocalDateTimeTwoMonthsAway = 67,
        LocalDateTimeTwoYearsAway = 68,
        LocalDateTimeLastMonth = 69,
        LocalDateTimeLastYear = 70,
        LocalDateTimeYearBeforeToday = 71,
        IsOutlookIntervalBeyondThisYear = 72,
        IsOutlookIntervalLaterThisYear = 73,
        IsOutlookIntervalLaterThisMonth = 74,
        IsOutlookIntervalNextWeek = 75,
        IsOutlookIntervalLaterThisWeek = 76,
        IsOutlookIntervalTomorrow = 77,
        IsOutlookIntervalToday = 78,
        IsOutlookIntervalYesterday = 79,
        IsOutlookIntervalEarlierThisWeek = 80,
        IsOutlookIntervalLastWeek = 81,
        IsOutlookIntervalEarlierThisMonth = 82,
        IsOutlookIntervalEarlierThisYear = 83,
        IsOutlookIntervalPriorThisYear = 84,
        IsThisWeek = 85,
        IsThisMonth = 86,
        IsThisYear = 87,
        IsNextMonth = 88,
        ...
        AddMonths = 152,
        AddYears = 153,
        DateTimeFromParts = 154,
        DateOnlyFromParts = 155,
        TimeOnlyFromParts = 156
    }
...
declare module DevExpress.QueryBuilder.Elements {
    ...
    export class ColumnViewModel extends QueryElementBaseViewModel {
        ...
        get specifics(): "String" | "Date" | "Bool" | "Integer" | "Float" | "Time";
    }
...
declare module DevExpress.QueryBuilder.Utils {
    ...
    export class RequestWrapper {
        sendRequest<T = any>(action: string, arg: any): DevExpress.Analytics.Internal.DxPromise<T>;
...
declare module DevExpress.Analytics.Widgets.Filtering {
    ...
    export class CriteriaOperatorSurface<T extends DevExpress.Analytics.Criteria.CriteriaOperator = DevExpress.Analytics.Criteria.CriteriaOperator> extends Disposable {
        ...
        parent: DevExpress.Analytics.Widgets.Filtering.CriteriaOperatorSurface;
        templateName: string;
        isSelected: ko.Observable<boolean> | ko.Computed<boolean>;
    ...
    export class OperandSurfaceBase<T extends DevExpress.Analytics.Criteria.CriteriaOperator> extends CriteriaOperatorSurface<T> {
        ...
        getConvertableParameters(destinationSpecifics: string, destinationType: string): any[];
    ...
    export class OperandValueSurface extends OperandSurfaceBase<DevExpress.Analytics.Criteria.OperandValue> {
        ...
        getDateEditorOptions: (element: HTMLElement, $root: any, specifics: string) => {
            value: ko.Observable<any>;
            onFocusOut: () => any;
            onFocusIn: () => void;
