...
export declare function getDockedElementCallback($targetElement: IJQueryWrapper, $viewer: IJQueryWrapper, $window: Window, selector: string, position?: IElementPosition): (element: Element) => void;
