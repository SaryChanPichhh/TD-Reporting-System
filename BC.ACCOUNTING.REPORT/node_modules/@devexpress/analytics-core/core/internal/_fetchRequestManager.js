...
export class FetchRequestManager {
    constructor(fetchSettingsFn, getRequestBodyFn, prepareRequestArgsFn) {
        ...
        this.getRequestBody = getRequestBodyFn;
        this.prepareRequestArgs = prepareRequestArgsFn;
    }
    ...
    _prepareParams(settings) {
        ...
        if (method === GET && data) {
            ...
            if (data['args'])
                data['args'] = this.prepareRequestArgs(data['args'], true, true);
        }
