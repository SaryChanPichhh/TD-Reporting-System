...
const orientationValues = [
    { displayValue: 'Horizontal', value: 'Horizontal', localizationId: 'DevExpress.XtraReports.Parameters.Orientation.Horizontal' },
    { displayValue: 'Vertical', value: 'Vertical', localizationId: 'DevExpress.XtraReports.Parameters.Orientation.Vertical' }
];
...
const title = { propertyName: 'title', localizable: true, modelName: '@Title', displayName: 'Title', localizationId: 'ASPxReportsStringId.ReportDesigner_ParametersDialog_GroupTitle', editor: editorTemplates.getEditor('text'), defaultVal: '' };
