...
export function createViewModel(viewModel) {
    ...
    const TextProcessingResultHeaderTest = getLocalization('Result', 'ASPxReportsStringId.AIPanel_ProcessingResultHeader');
    ...
    const aiPanelViewModel = createViewModelGenerator(viewModel)
        ...
        .getViewModel())
        .getViewModel())
        .generateProperty('getSelecBoxOptions', (options, element) => {
        ...
        .generateProperty('languageSelecBoxOptions', createViewModelGenerator()
        ...
        .getViewModel())
        .generateProperty('targetSelecBoxOptions', createViewModelGenerator()
        .generateProperty('valueExpr', 'key')
        .generateProperty('displayExpr', 'text')
        ...
        this.pageSelecBoxVisible = (this.selectedTarget === TextSourceTarget.Page);
    })
        .generateProperty('inputAttr', { 'aria-label': TargetContentText })
        .getViewModel())
        .generateProperty('pageSelecBoxOptions', createViewModelGenerator()
        .generateProperty('valueExpr', 'key')
        .generateProperty('displayExpr', 'text')
        .generateProperty('dataSource', this.pagesListDataSource)
        .generateProperty('value', this.selectedPage)
        .generateProperty('visible', this.pageSelecBoxVisible)
        ...
        .generateProperty('proceedForAllChunks', this.proceedForAllChunks)
        .generateProperty('pageSelecBoxVisible', this.pageSelecBoxVisible)
        ...
        .generateProperty('summarizeActionText', SummarizeActionText)
        .generateProperty('translateActionText', TranslateActionText)
        .generateProperty('textProcessingResultHeaderTest', TextProcessingResultHeaderTest)
