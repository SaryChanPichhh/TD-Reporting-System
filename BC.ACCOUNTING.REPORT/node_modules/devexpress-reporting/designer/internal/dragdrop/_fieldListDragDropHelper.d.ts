...
import { DxPromise, ISelectionTarget } from '@devexpress/analytics-core/analytics-internal';
...
export declare class FieldListDragDropHelper {
    ...
    createTableFromListSource(treeListItem: ITreeListItemViewModel, parent: XRReportElementViewModel): DxPromise<IElementViewModel>;
    createTableFromItems(treeListItems: TreeListItemViewModel[], parent: ElementViewModel): DxPromise<IElementViewModel>;
}
...
interface IListMemberContol extends IMemberContolBase {
    drop: (treeListItem: ITreeListItemViewModel, dropTargetControl: XRReportElementViewModel, dataBindingMode: DataBindingMode, size?: ISize) => DxPromise<IElementViewModel>;
}
