...
const defaultFunctionDisplay = [
    {
        ...
        items: {
            ...
            LocalDateTimeDayAfterTomorrow: [{ paramCount: 1, text: 'LocalDateTimeDayAfterTomorrow()', descriptionStringId: 'ExpressionEditorStringId.Function_LocalDateTimeDayAfterTomorrow' }],
            LocalDateTimeLastMonth: [{ paramCount: 1, text: 'LocalDateTimeLastMonth()', descriptionStringId: 'ExpressionEditorStringId.Function_LocalDateTimeLastMonth' }],
            LocalDateTimeLastWeek: [{ paramCount: 1, text: 'LocalDateTimeLastWeek()', descriptionStringId: 'ExpressionEditorStringId.Function_LocalDateTimeLastWeek' }],
            LocalDateTimeLastYear: [{ paramCount: 1, text: 'LocalDateTimeLastYear()', descriptionStringId: 'ExpressionEditorStringId.Function_LocalDateTimeLastYear' }],
            LocalDateTimeNextMonth: [{ paramCount: 1, text: 'LocalDateTimeNextMonth()', descriptionStringId: 'ExpressionEditorStringId.Function_LocalDateTimeNextMonth' }],
            LocalDateTimeNextWeek: [{ paramCount: 1, text: 'LocalDateTimeNextWeek()', descriptionStringId: 'ExpressionEditorStringId.Function_LocalDateTimeNextWeek' }],
            LocalDateTimeNextYear: [{ paramCount: 1, text: 'LocalDateTimeNextYear()', descriptionStringId: 'ExpressionEditorStringId.Function_LocalDateTimeNextYear' }],
            LocalDateTimeNow: [{ paramCount: 1, text: 'LocalDateTimeNow()', descriptionStringId: 'ExpressionEditorStringId.Function_LocalDateTimeNow' }],
            LocalDateTimeThisMonth: [{ paramCount: 1, text: 'LocalDateTimeThisMonth()', descriptionStringId: 'ExpressionEditorStringId.Function_LocalDateTimeThisMonth' }],
            LocalDateTimeThisWeek: [{ paramCount: 1, text: 'LocalDateTimeThisWeek()', descriptionStringId: 'ExpressionEditorStringId.Function_LocalDateTimeThisWeek' }],
            LocalDateTimeThisYear: [{ paramCount: 1, text: 'LocalDateTimeThisYear()', descriptionStringId: 'ExpressionEditorStringId.Function_LocalDateTimeThisYear' }],
            LocalDateTimeToday: [{ paramCount: 1, text: 'LocalDateTimeToday()', descriptionStringId: 'ExpressionEditorStringId.Function_LocalDateTimeToday' }],
            LocalDateTimeTomorrow: [{ paramCount: 1, text: 'LocalDateTimeTomorrow()', descriptionStringId: 'ExpressionEditorStringId.Function_LocalDateTimeTomorrow' }],
            LocalDateTimeTwoMonthsAway: [{ paramCount: 1, text: 'LocalDateTimeTwoMonthsAway()', descriptionStringId: 'ExpressionEditorStringId.Function_LocalDateTimeTwoMonthsAway' }],
            LocalDateTimeTwoWeeksAway: [{ paramCount: 1, text: 'LocalDateTimeTwoWeeksAway()', descriptionStringId: 'ExpressionEditorStringId.Function_LocalDateTimeTwoWeeksAway' }],
            LocalDateTimeTwoYearsAway: [{ paramCount: 1, text: 'LocalDateTimeTwoYearsAway()', descriptionStringId: 'ExpressionEditorStringId.Function_LocalDateTimeTwoYearsAway' }],
            LocalDateTimeYearBeforeToday: [{ paramCount: 1, text: 'LocalDateTimeYearBeforeToday()', descriptionStringId: 'ExpressionEditorStringId.Function_LocalDateTimeYearBeforeToday' }],
            LocalDateTimeYesterday: [{ paramCount: 1, text: 'LocalDateTimeYesterday()', descriptionStringId: 'ExpressionEditorStringId.Function_LocalDateTimeYesterday' }],
            Now: [{ paramCount: 1, text: 'Now()', descriptionStringId: 'ExpressionEditorStringId.Function_Now' }],
            Today: [{ paramCount: 1, text: 'Today()', descriptionStringId: 'ExpressionEditorStringId.Function_Today' }],
            UtcNow: [{ paramCount: 1, text: 'UtcNow()', descriptionStringId: 'ExpressionEditorStringId.Function_UtcNow' }],
            ...
            DateTimeFromParts: [{ paramCount: 6, text: 'DateTimeFromParts(, , , , , )', descriptionStringId: 'ExpressionEditorStringId.Function_DateTimeFromParts6' }],
            ...
            TimeOnlyFromParts: [{ paramCount: 4, text: 'TimeOnlyFromParts(, , , )', descriptionStringId: 'ExpressionEditorStringId.Function_TimeOnlyFromParts2' }],
            AfterMidday: [{ paramCount: 1, text: 'AfterMidday()', descriptionStringId: 'ExpressionEditorStringId.Function_AfterMidday' }],
            BeforeMidday: [{ paramCount: 1, text: 'BeforeMidday()', descriptionStringId: 'ExpressionEditorStringId.Function_BeforeMidday' }],
            IsAfternoon: [{ paramCount: 1, text: 'IsAfternoon()', descriptionStringId: 'ExpressionEditorStringId.Function_IsAfternoon' }],
            IsEvening: [{ paramCount: 1, text: 'IsEvening()', descriptionStringId: 'ExpressionEditorStringId.Function_IsEvening' }],
            IsFreeTime: [{ paramCount: 1, text: 'IsFreeTime()', descriptionStringId: 'ExpressionEditorStringId.Function_IsFreeTime' }],
            IsLastHour: [{ paramCount: 1, text: 'IsLastHour()', descriptionStringId: 'ExpressionEditorStringId.Function_IsLastHour' }],
            IsLunchTime: [{ paramCount: 1, text: 'IsLunchTime()', descriptionStringId: 'ExpressionEditorStringId.Function_IsLunchTime' }],
            IsMorning: [{ paramCount: 1, text: 'IsMorning()', descriptionStringId: 'ExpressionEditorStringId.Function_IsMorning' }],
            IsNextHour: [{ paramCount: 1, text: 'IsNextHour()', descriptionStringId: 'ExpressionEditorStringId.Function_IsNextHour' }],
            IsNight: [{ paramCount: 1, text: 'IsNight()', descriptionStringId: 'ExpressionEditorStringId.Function_IsNight' }],
            IsSameHour: [{ paramCount: 1, text: 'IsSameHour()', descriptionStringId: 'ExpressionEditorStringId.Function_IsSameHour' }],
            IsSameTime: [{ paramCount: 1, text: 'IsSameTime()', descriptionStringId: 'ExpressionEditorStringId.Function_IsSameTime' }],
            IsThisHour: [{ paramCount: 1, text: 'IsThisHour()', descriptionStringId: 'ExpressionEditorStringId.Function_IsThisHour' }],
            IsWorkTime: [{ paramCount: 1, text: 'IsWorkTime()', descriptionStringId: 'ExpressionEditorStringId.Function_IsWorkTime' }],
