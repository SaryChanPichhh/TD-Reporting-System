...
import { addCultureInfo, requestManager } from '@devexpress/analytics-core/analytics-utils';
...
export function createReportDesigner(element, data, callbacks, localizationSettings, knownEnums, designerHandlerUri, previewHandlerUri, rtl, applyBindings = true) {
    ...
    if (data.requestContentType)
        requestManager._setRequestContentType(data.requestContentType.toString());
