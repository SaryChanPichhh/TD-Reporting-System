...
import { DxDeferred, IJQueryWrapper } from '../core/utils/_jqueryUtils';
...
export declare function updateQueryBuilderSurfaceContentSize(getRoot: () => IJQueryWrapper, surfaceSize: ko.Observable<number> | ko.Computed<number>, surface: ko.Observable<QuerySurface>, updateLayoutCallbacks?: Array<() => void>): () => void;
...
export declare function createQueryBuilder(element: HTMLElement, options: IQueryBuilderOptions, callbacks: IQueryBuilderCustomizationHandler, applyBindings?: boolean): DxDeferred<IQueryBuilderModel>;
export declare function createQueryBuilderSurface(element: HTMLElement, options: IQueryBuilderOptions, queryCreator: (options: IQueryBuilderOptions) => QueryViewModelBase): IQueryBuilderModel;
