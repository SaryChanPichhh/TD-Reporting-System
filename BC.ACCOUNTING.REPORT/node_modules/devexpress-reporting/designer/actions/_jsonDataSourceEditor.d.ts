...
export declare class JsonDataSourceEditor extends DataSourceEditorBase {
    ...
    saveJsonSource(state: IDataSourceWizardState, connections: IDataSourceWizardConnectionStrings): DxPromise<any>;
    static createJsonDataSourceInfo(source: JsonDataSource): DxPromise<IDataSourceInfo>;
    editSchemaAction: {
