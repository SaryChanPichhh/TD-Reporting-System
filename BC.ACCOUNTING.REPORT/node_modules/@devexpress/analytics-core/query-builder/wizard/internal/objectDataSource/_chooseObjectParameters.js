...
import { isDateType, serializeParameterDate } from '../../../../serializer/_date.utiles';
...
export class ObjectDataSourceParameterProperty extends Disposable {
    ...
    _patchOriginalParameterValue(value) {
        ...
        if (value && isDateType(this._parameter.resultType) && value instanceof Date)
            this._parameter.value = serializeParameterDate(value, type);
        else
