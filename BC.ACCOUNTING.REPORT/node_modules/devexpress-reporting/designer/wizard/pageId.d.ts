...
*/
export declare const LegacyReportWizardPageId: {
...
export declare const ReportWizardPageId: {
...
export declare const FullscreenReportWizardPageId: {
    SelectReportTypePage: string;
...
export declare const FullscreenReportWizardSectionId: {
    ChooseAvailableDataSourcePage: string;
    SelectLabelTypePage: string;
    CustomizeLabelPage: string;
