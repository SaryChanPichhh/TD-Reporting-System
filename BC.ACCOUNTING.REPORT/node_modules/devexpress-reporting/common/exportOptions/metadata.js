...
export const allowFloatingPictures = {
    propertyName: 'allowFloatingPictures',
    modelName: '@AllowFloatingPictures',
    localizationId: 'DevExpress.XtraPrinting.DocxExportOptions.AllowFloatingPictures',
    displayName: 'Allow Floating Pictures',
    editor: analyticEditorTemplates.getEditor('bool'),
    from: parseBool,
    defaultVal: false
};
export const docxDocumentOptions = {
    propertyName: 'documentOptions',
    modelName: 'DocumentOptions',
    displayName: 'Document Options',
    localizationId: 'DevExpress.XtraPrinting.DocxExportOptions.DocumentOptions',
    from: DocxExportDocumentOptions.from,
    toJsonObject: DocxExportDocumentOptions.toJson,
    editor: analyticEditorTemplates.getEditor('objecteditor')
};
