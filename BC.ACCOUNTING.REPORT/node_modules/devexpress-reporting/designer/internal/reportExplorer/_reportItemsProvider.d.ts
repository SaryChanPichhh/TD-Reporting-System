...
*/
import { DesignControlsHelper, DxPromise } from '@devexpress/analytics-core/analytics-internal';
...
export declare class ReportItemsProvider extends Disposable implements IItemsProvider {
    ...
    getItems: (path: IPathRequest, rootItems?: IReportItemsProviderRootItems) => DxPromise<IDataMemberInfo[]>;
    getItemByPath: (path: IPathRequest, rootItems?: IReportItemsProviderRootItems) => DxPromise<IDataMemberInfo>;
    constructor(controlsHelper: DesignControlsHelper, fieldListProvider: IItemsProvider);
    _getItemByPath(pathParts: string[], rootItems: IReportItemsProviderRootItems, propertyName: string): DxPromise<IDataMemberInfo>;
}
