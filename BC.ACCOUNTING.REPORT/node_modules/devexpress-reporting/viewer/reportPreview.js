...
import { CustomSortedArrayStore, DxDeferred, formatUnicorn, _addLicenseTrigger } from '@devexpress/analytics-core/analytics-internal-native';
import { mutable, mutableArray, nativeModelSerializer } from '@devexpress/analytics-core/analytics-serializer-native';
...
export class ReportPreview extends ReportHolder {
    ...
    _resolveFirstPage(status) {
        ...
        if (firstPage.displayImageSrc || firstPage.svgMarkup || status.pageCount === 0)
            return;
    ...
    _startBuildRequest() {
        const documentIdDeferred = new DxDeferred();
    ...
    getDocumentData(documentId) {
        ...
        documentDataDeferred.done((response) => {
            ...
            const isMerged = this.reportId
                ...
                : !this._initialDocumentData?.canPerformContinuousExport;
    ...
    updatePage(page, zoom = this.originalZoom, forcePng = false) {
        page._setPageImgSrc(this.documentId, this._unifier, zoom, this.documentBuilding, forcePng);
    }
