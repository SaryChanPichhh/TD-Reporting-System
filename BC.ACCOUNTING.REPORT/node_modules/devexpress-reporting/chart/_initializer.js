...
import { $dx, ActionLists, addDisposeCallback, appendStaticContextToRootViewModel, DragHelperContent, extend, FieldListProvider, staticContext } from '@devexpress/analytics-core/analytics-internal';
...
export function createChartDesigner(element, options, applyBindings = true) {
    ...
    }, { value: legendName.defaultVal, displayValue: getLocalization(legendName.defaultVal, 'ChartStringId.DefaultLegend') });
...
ko.bindingHandlers['dxChartDesigner'] = {
    init: function (element, valueAccessor) {
        ...
        const templateHtml = getTemplate('dxrd-designer');
        const $element = $dx(element).empty().append(templateHtml);
