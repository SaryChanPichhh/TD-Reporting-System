...
export const useSvgRendering = { propertyName: 'useSvgRendering', modelName: '@UseSvgRendering', defaultVal: false };
const pageRangePdfContent = extend({}, pageRange, { localizationId: 'DevExpress.XtraReports.UI.XRPdfContent.PageRange' });
export const pdfContentSerializationInfo = [pdfSource, pdfSourceUrl, pdfContentScripts, generateOwnPagesPdfContent, pageRangePdfContent, pageCount, useSvgRendering, dataBindings(['Bookmark', 'Source', 'SourceUrl', 'PageRange'])].concat(sizeLocation, baseControlProperties, bookmarkGroup, [tag]);
