...
addToBindingsCache('visible: isHAxisVisible, css: { \'dxd-dimension-notations-inside-elt\' : isLocatedInsideContainer }', function ($context, $element) { return { 'visible': function () { return $context.$data.isHAxisVisible; }, 'css': function () { return { 'dxd-dimension-notations-inside-elt': $context.$data.isLocatedInsideContainer }; } }; });
addToBindingsCache('text: width', function ($context, $element) { return { 'text': function () { return $context.$data.width; } }; });
addToBindingsCache('visible: isVAxisVisible, css: { \'dxd-dimension-notations-inside-elt\' : isLocatedInsideContainer }', function ($context, $element) { return { 'visible': function () { return $context.$data.isVAxisVisible; }, 'css': function () { return { 'dxd-dimension-notations-inside-elt': $context.$data.isLocatedInsideContainer }; } }; });
addToBindingsCache('text: height', function ($context, $element) { return { 'text': function () { return $context.$data.height; } }; });
