...
*/
import { koUtils, replaceInvalidSymbols } from '@devexpress/analytics-core/analytics-internal';
...
export class ReportLocalizationEngine extends Disposable {
    constructor(report) {
        ...
        report._localizationItems().forEach(item => {
            const component = koUtils.unwrap(item.component);
            if (component) {
                const propertyName = koUtils.unwrap(item.propertyName);
