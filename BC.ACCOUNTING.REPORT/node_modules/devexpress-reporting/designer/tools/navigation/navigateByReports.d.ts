...
export declare class NavigateByReports extends Disposable {
    ...
    removeTab(tab: any, force?: boolean): import("@devexpress/analytics-core/analytics-internal").DxPromise<any>;
    closeAll(): import("@devexpress/analytics-core/analytics-internal").DxPromise<any>;
    ...
    addTab(report: ReportViewModel, url?: ko.Observable<string> | ko.Computed<string>, onCancel?: () => any, newReportName?: string): import("@devexpress/analytics-core/analytics-internal").DxPromise<any>;
    checkHeight(): void;
