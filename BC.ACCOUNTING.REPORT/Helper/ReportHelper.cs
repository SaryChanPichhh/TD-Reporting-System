                        ...
                        {
                            {
                                ...
                                new List<(ReportModes reportModes, string reportName)>
                                {
                                    (ReportModes.NormalMode, "DailyClosingInventoryDetail80mmEVReport.repx")
                                }
                            },{
                                Languages.KM,
                                new List<(ReportModes reportModes, string reportName)>
                            ...
                            },
                            {
                                ...
                                new List<(ReportModes reportModes, string reportName)>
                                {
                                    (ReportModes.NormalMode, "DailyClosingInventoryDetail80mmCNReport.repx")
                                }
                            },
                        }
                    },
                        ...
                        {
                            {
                                ...
                                new List<(ReportModes reportModes, string reportName)>
                                {
                                    (ReportModes.NormalMode, "DailyClosingInventoryDetailA4EVReport.repx")
                                }
                            },{
                                Languages.KM,
                                new List<(ReportModes reportModes, string reportName)>
                        ...
                        {
                            {
                                ...
                                new List<(ReportModes reportModes, string reportName)>
                                {
                                    (ReportModes.NormalMode, "RESSaleListingInvoiceProfitBySellerDateENGReport.repx")
                                }
                            },
                            {
                                Languages.ZH_CN,
                        ...
                        {
                            {
                                ...
                                new List<(ReportModes reportModes, string reportName)>
                                {
                                    (ReportModes.NormalMode, "RESBZSaleInvoiceA5ENGReport.repx")
                                }
                            },
                            {
                                Languages.KM,
