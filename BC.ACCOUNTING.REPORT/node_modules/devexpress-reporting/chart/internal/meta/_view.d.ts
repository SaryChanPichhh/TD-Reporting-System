...
export declare const paneName: ISerializationInfo;
export declare const axisXName: ISerializationInfo;
export declare const axisYName: ISerializationInfo;
export declare const viewMapper: {
    ...
    BoxPlotSeriesView: ISerializationInfoArray;
};
