...
export class PageLoader {
    ...
    _performPrefetch(pagesToUpdate, resolution, forcePng) {
        pagesToUpdate.forEach(page => this._preview.updatePage(page, resolution, forcePng));
    }
    ...
    prefetchPages(startIndex, endIndex, currentPageIndex) {
        ...
        this._performPrefetch(pendingPages, zoom, forcePng);
