...
.dx-overlay-wrapper .dx-popup-content {
    .dxa-tasks-smart-tag-content .dx-editors .dx-fieldset .dx-editor {
...
.dx-designer-viewport {
    ...
    .dx-editors {
        ...
        .dx-fieldset {
            .dx-field {
                ...
                .dx-field-label:not(.dxrd-textalignment-editor-label) {
                    padding-top: 8px;
                }
                ...
                .dxrd-bordereditor, .dxrd-textalignment-editor {
                    margin-top: 2px;
                }
            }
        }
    ...
    // Checkboxes in Report Wizard
    .dx-checkbox.dx-add-queries-page-checkbox {
        top: 3px;
    }
    ...
    .dxrd-error-panel {
        ...
        .dxrd-error-panel-content {            
            .dx-buttongroup-first-item .dx-buttongroup-item-content {
                padding-left: 4px;
            }
