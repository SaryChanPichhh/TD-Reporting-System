...
{
    public partial class SaleListingByInvoiceNoProfitEVReport : DevExpress.XtraReports.UI.XtraReport
    {
        public SaleListingByInvoiceNoProfitEVReport()
        {
            InitializeComponent();
        }
        public SaleListingByInvoiceNoProfitEVReport(POSSaleListingByInvoiceDto dto, string reportName)
        {
