...
export declare const SqlDataSourceWizardPageId: {
...
export declare const FederationDataSourceWizardPageId: {
    FederatedQueryConfigurePage: string;
    FederatedMasterDetailRelationshipsPage: string;
};
export declare const JsonDataSourceWizardPageId: {
    ChooseJsonSourcePage: string;
    ChooseJsonSchemaPage: string;
    ChooseConnectionPage: string;
    SpecifyJsonConnectionPage: string;
};
export declare const ObjectDataSourceWizardPageId: {
    ChooseTypesPage: string;
    ChooseDataMembersPage: string;
    ConfigureParametersPage: string;
};
export declare const FullscreenDataSourceWizardPageId: {
    ChooseDataSourceTypePage: string;
...
export declare const FullscreenDataSourceWizardSectionId: {
    SpecifyJsonConnectionPage: string;
    ChooseJsonSchemaPage: string;
    ChooseJsonSourcePage: string;
