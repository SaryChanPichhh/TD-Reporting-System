...
{
    public partial class M01SaleListingDailyDetailByDateReport : DevExpress.XtraReports.UI.XtraReport
    {
        public M01SaleListingDailyDetailByDateReport()
        {
            InitializeComponent();
        }
        public M01SaleListingDailyDetailByDateReport(List<SaleListingModel> ls, string reportName, SaleListingDto dto)
        {
            ...
            if (reportName.Equals("M01SaleListingDetailBySellerReport"))
            {
                ...
                {
                    if (header.SubItems == null || header.SubItems.Count == 0)
                        continue;
