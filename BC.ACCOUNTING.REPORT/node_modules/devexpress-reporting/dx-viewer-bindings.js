...
addToBindingsCache('dxSelectBox: getSelecBoxOptions(targetSelecBoxOptions, $element)', function ($context, $element) { return { 'dxSelectBox': function () { return $context.$data.getSelecBoxOptions($context.$data.targetSelecBoxOptions, $element); } }; });
...
addToBindingsCache('dxSelectBox: getSelecBoxOptions(languageSelecBoxOptions, $element)', function ($context, $element) { return { 'dxSelectBox': function () { return $context.$data.getSelecBoxOptions($context.$data.languageSelecBoxOptions, $element); } }; });
addToBindingsCache('text: pageSelectText', function ($context, $element) { return { 'text': function () { return $context.$data.pageSelectText; } }; });
addToBindingsCache('dxSelectBox: getSelecBoxOptions(pageSelecBoxOptions, $element)', function ($context, $element) { return { 'dxSelectBox': function () { return $context.$data.getSelecBoxOptions($context.$data.pageSelecBoxOptions, $element); } }; });
...
addToBindingsCache('text: textProcessingResultHeaderTest', function ($context, $element) { return { 'text': function () { return $context.$data.textProcessingResultHeaderTest; } }; });
...
addToBindingsCache('template: { name: buttons.copyResultButton.template }, dxclick: buttons.copyResultButton.onClick', function ($context, $element) { return { 'template': function () { return { 'name': $context.$data.buttons.copyResultButton.template }; }, 'dxclick': function () { return $context.$data.buttons.copyResultButton.onClick; } }; });
addToBindingsCache('dxTextArea: { value: aiProcessingResultText, onInput: function(e) { e.event.preventDefault(); }, onPaste: function(e) { e.event.preventDefault(); }, onKeyDown: function(e) { if (e.event.key !== \'Tab\') e.event.preventDefault(); }, hoverStateEnabled: false, inputAttr: { spellcheck: \'false\' }, tabIndex: -1 }', function ($context, $element) { return { 'dxTextArea': function () { return { 'value': $context.$data.aiProcessingResultText, 'onInput': function (e) { e.event.preventDefault(); }, 'onPaste': function (e) { e.event.preventDefault(); }, 'onKeyDown': function (e) { if (e.event.key !== 'Tab') {
            e.event.preventDefault();
        } }, 'hoverStateEnabled': false, 'inputAttr': { 'spellcheck': 'false' }, 'tabIndex': -1 }; } }; });
addToBindingsCache('dxPopup: { width: 350, height: 200, shading: false, focusStateEnabled: false, visible: warningTextLimitPopupVisible, container: \'.dxrd-preview-ai-panel\', target: \'.dxrd-preview-ai-panel\', position: { at: \'top\', my: \'top\', collision: \'fit\', of: \'.dxrd-preview-ai-panel\' }, showCloseButton: false, showTitle: false, wrapperAttr: { class: \'dxrd-preview-ai-panel-warning-popup\' }, }', function ($context, $element) { return { 'dxPopup': function () { return { 'width': 350, 'height': 200, 'shading': false, 'focusStateEnabled': false, 'visible': $context.$data.warningTextLimitPopupVisible, 'container': '.dxrd-preview-ai-panel', 'target': '.dxrd-preview-ai-panel', 'position': { 'at': 'top', 'my': 'top', 'collision': 'fit', 'of': '.dxrd-preview-ai-panel' }, 'showCloseButton': false, 'showTitle': false, 'wrapperAttr': { 'class': 'dxrd-preview-ai-panel-warning-popup' } }; } }; });
addToBindingsCache('text: limitExceededWarningMsg', function ($context, $element) { return { 'text': function () { return $context.$data.limitExceededWarningMsg; } }; });
addToBindingsCache('dxCheckBox: proceedForAllCheckBoxOptions', function ($context, $element) { return { 'dxCheckBox': function () { return $context.$data.proceedForAllCheckBoxOptions; } }; });
addToBindingsCache('dxButton: { text: proceedNextChunkButtonText, onClick: proceedNextButtonClick }', function ($context, $element) { return { 'dxButton': function () { return { 'text': $context.$data.proceedNextChunkButtonText, 'onClick': $context.$data.proceedNextButtonClick }; } }; });
addToBindingsCache('dxButton: { text: cancelChunkedOperationButtonText, onClick: cancelProcessButtonClick }', function ($context, $element) { return { 'dxButton': function () { return { 'text': $context.$data.cancelChunkedOperationButtonText, 'onClick': $context.$data.cancelProcessButtonClick }; } }; });
...
addToBindingsCache('if: pageSelecBoxVisible', function ($context, $element) { return { 'if': function () { return $context.$data.pageSelecBoxVisible; } }; });
addToBindingsCache('if: resultVisible', function ($context, $element) { return { 'if': function () { return $context.$data.resultVisible; } }; });
...
addToBindingsCache('if: pageLoading || (!pageLoading && pageLoaded)', function ($context, $element) { return { 'if': function () { return $context.$data.pageLoading || (!$context.$data.pageLoading && $context.$data.pageLoaded); } }; });
...
addToBindingsCache('lazy: { if: pageLoading || (!pageLoading && pageLoaded) }', function ($context, $element) { return { 'lazy': function () { return { 'if': $context.$data.pageLoading || (!$context.$data.pageLoading && $context.$data.pageLoaded) }; } }; });
