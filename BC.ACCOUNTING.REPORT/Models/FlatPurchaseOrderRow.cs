...
{
    public class FlatPurchaseOrderRow
    { 
        ...
        public string ItemDescCN { get; set; } = string.Empty;      // Item Name/Description
        ...
        [Description("សរុប")]public decimal Total { get; set; }          // From UnitConvert
    }
