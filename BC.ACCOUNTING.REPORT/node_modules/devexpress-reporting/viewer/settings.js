...
export var PageRenderFormat;
(function (PageRenderFormat) {
    PageRenderFormat[PageRenderFormat["Auto"] = 0] = "Auto";
    PageRenderFormat[PageRenderFormat["Svg"] = 1] = "Svg";
    PageRenderFormat[PageRenderFormat["Png"] = 2] = "Png";
...
export const PreviewRenderFormat = createGlobalModuleVariableFunc(PageRenderFormat.Png);
export const AIServicesEnabled = createGlobalModuleVariableFunc(false);
export const AILanguages = createGlobalModuleVariableFunc([]);
