...
import { bookmarkDuplicateSuppress, calculatedFields, defaultPrinterSettingsUsingInfo, designerOptions, drawWatermark, horizontalContentSplitting, landscape, language, margins, measureUnit, pageColor, pageHeight, pageWidth, paperKind, parametersInfo, reportExportOptionsSerializationInfo, requestParameters, rollPaper, rtlLayout, rtlReport, scriptLanguage, scriptReferencesString, showPreviewMarginLines, snapGridSize, verticalContentSplitting, watermarkId, watermarks } from '../controls/metadata/xrReport';
...
export const groups = {
    ...
    'Design': {
        info: [name, snapGridSize, drawWatermark, language, designerOptions],
