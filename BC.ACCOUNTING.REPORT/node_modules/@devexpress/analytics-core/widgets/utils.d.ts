...
export interface IItemsProvider {
    getItems: (path: IPathRequest) => DxPromise<IDataMemberInfo[]>;
    subscribeOnItemsChanged?: (item: TreeListItemViewModel, callback: (promise: DxPromise<IDataMemberInfo[]>) => void) => () => void;
