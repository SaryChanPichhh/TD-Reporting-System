...
export declare let uploadFile: (options: IFileUploadOptions) => import("../../../core/utils/_jqueryUtils").DxPromise<IFileUploadResult>;
...
export interface IControlPropertiesViewModel {
    ...
    getPropertyDependencies?: (name: string, status: IControlPropertyStatus) => SubscribableProperty<any>[];
    controlType?: string;
