...
export declare class ChooseJsonSchemaPage extends ChooseAnalyticJsonSchemaPage {
    ...
    constructor(createJsonDataSourceInfo: (dataSource: JsonDataSource) => DxPromise<IDataSourceInfo>);
    initialize(state: any): JQueryPromise<import("@devexpress/analytics-core/analytics-data").JsonSchemaRootNode>;
